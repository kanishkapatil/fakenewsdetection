...
//           <button onClick={logout} className="w-full flex items-center gap-3 px-4 py-3 text-sm font-bold text-rose-500 hover:bg-rose-50 rounded-xl transition-all">
//             <span>🚪</span> Logout
//           </button>
//         </div>
//       </aside>
...
//     { id: "credibility", label: "Credibility", icon: "🛡️", path: "/dashboard/credibility" },
//     { id: "chatbot", label: "AI Chatbot", icon: "🤖", path: "/dashboard/chatbot" },
//     { id: "history", label: "History", icon: "📜", path: "/dashboard/history" }, // New Item
//   ];
...
//         {/* --- USER SECTION --- */}
//         <div className="p-4 border-t border-slate-100">
//           <p className="px-4 text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Account</p>
//           <button 
//             onClick={logout} 
...
//       <main className="flex-1 overflow-y-auto">
//         <div className="p-10">
//           {/* History.jsx will render here when URL is /dashboard/history */}
//           <Outlet /> 
//         </div>
//       </main>
//     </div>
